...
public class MoFragment extends Fragment implements IView {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.mo_layout_fragment, null);
    ...
    private void initView() {
        ...
        mMrecy.setLayoutManager(linearLayoutManager);
        linerAdapter = new LinerAdapter(getActivity());
        mMrecy.setAdapter(linerAdapter);
    }
    ...
    private void initImageData() {
        mMbanner.setData(mImage, null);
        mMbanner.loadImage(new XBanner.XBannerAdapter() {
            @Override
